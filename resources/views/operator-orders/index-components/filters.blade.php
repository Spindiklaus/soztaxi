...
<form action="{{ request()->route()->getName() ? route(request()->route()->getName()) : route('operator.social-taxi.index') }}" method="GET" class="bg-white shadow rounded-lg mb-4">
    ...
    <div class="px-4 py-2 bg-gray-50 border-b border-gray-200">
            <button type="button" 
                ...
                <svg id="filter-arrow" class="h-5 w-5 transform transition-transform  ml-2" 
    ...
    <!-- Содержимое фильтров  -->
    <div id="filters-content" class="px-4 py-2">
        <div class="grid grid-cols-1 md:grid-cols-8 gap-2 mb-0">
            ...
            <div class="md:col-span-2">
                <label for="client_fio" class="block text-sm font-medium text-gray-700">ФИО клиента ( тел., уд., сопр.)</label>
            ...
            <div class="md:col-span-2 flex items-end gap-2">
                <button type="submit" title = "Применить фильтр"
