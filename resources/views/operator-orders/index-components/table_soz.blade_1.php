...
<!--                    <th scope="col" class="px-6 py-3 text-left text-xs font-bold uppercase tracking-wider">
                    ...
                    <th scope="col" class="px-6 py-3 w-56 min-w-56 text-left text-xs font-bold uppercase tracking-wider">
                        Действия оператора
                    </th>
                </tr>
            </thead>
