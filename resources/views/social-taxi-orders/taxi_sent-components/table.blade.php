    ...
    <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-yellow-600 text-gray-200">
                <tr>
                    <th @click="sortBy('pz_data')" scope="col" class="px-2 py-0 text-left text-xs font-bold uppercase tracking-wider cursor-pointer hover:bg-blue-700">
                        Заказ и статус
                    ...
                    <th scope="col" class="px-2 py-3 text-left text-xs font-bold uppercase tracking-wider">
                        Маршрут поездки
                    </th>
                    <th @click="sortBy('client_fio')" scope="col" class="px-2 py-0 text-left text-xs font-bold uppercase tracking-wider cursor-pointer hover:bg-blue-700">
                        Клиент
                    ...
                    <td class="px-2 py-0">
                        <div >
                            ...
                            <a href="{{ route('social-taxi-orders.show', array_merge(['social_taxi_order' => $order, 'from_taxi_page' => 1], $urlParams)) }}" 
                               class="inline-flex items-center px-3 py-1 bg-blue-100 text-blue-800 rounded-md hover:bg-blue-200 text-sm" title="Просмотр заказа" target="_blank">
