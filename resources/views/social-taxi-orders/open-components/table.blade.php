<!-- resources/views/sozial-taxi-orders/open-components/table.blade.php -->
<div x-data="{
                    ...
                    >
                        ...
                        <td class="px-6 py-4">
                            <div class="flex flex-col space-y-1">
                                ...
                                <a href="{{ route('social-taxi-orders.show', array_merge(['social_taxi_order' => $order, 'from_open_page' => 1], $urlParams)) }}" 
