...
<div id="client-trips-modal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50 p-4">
    <div class="bg-white rounded-lg w-full max-w-4xl min-w-[300px] max-h-[90vh] overflow-hidden flex flex-col mx-auto">
        <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
            <h3 id="modal-title" class="text-lg font-semibold text-gray-800">Поездки клиента</h3>
        ...
        <div class="overflow-y-auto flex-1">
            <div class="p-6">
                <div id="client-trips-content">
                    <!-- Здесь будут загружаться поездки -->
