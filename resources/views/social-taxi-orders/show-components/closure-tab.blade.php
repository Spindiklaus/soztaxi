<div id="closure" class="tab-content hidden">
    <div class="bg-gray-200 p-2 rounded-lg mb-2">
        <h2 class="text-lg font-semibold text-gray-800 mb-2">Закрытие (отмена) заказа</h2>
    ...
    <div class="bg-gray-200 p-2 rounded-lg">
        <h2 class="text-lg font-semibold text-gray-800 mb-2">История статусов заказа</h2>

        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        <th scope="col" class="px-6 py-1 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Дата</th>
                        <th scope="col" class="px-6 py-1 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Назначенный статус</th>
                        <th scope="col" class="px-6 py-1 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Оператор</th>
                    </tr>
                </thead>
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    @empty
                        <tr>
                            <td colspan="3" class="px-6 py-2 text-center text-gray-500">История отсутствует</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
