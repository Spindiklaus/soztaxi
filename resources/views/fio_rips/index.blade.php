            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-blue-800 text-gray-200">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3 text-left text-xs font-bold uppercase tracking-wider cursor-pointer hover:bg-blue-700">Адрес</th>
                        ...
                        <th scope="col" class="px-6 py-3 text-left text-xs font-bold uppercase tracking-wider cursor-pointer hover:bg-blue-700">Комментарии</th>
                ...
                <tbody class="divide-y divide-gray-200">
                    @foreach ($fioRips as $fioRip)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">{{ $fioRip->sex === 'М' ? 'Мужской' : ($fioRip->sex === 'Ж' ? 'Женский' : '-') }}</td>
                            <td class="px-6 py-4 whitespace-nowrap">{{ $fioRip->adres ?: '-' }}</td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">{{ $fioRip->komment ?: '-' }}</td>
