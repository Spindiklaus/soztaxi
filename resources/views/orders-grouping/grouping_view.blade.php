 ...
 <x-app-layout>
        <div class="container mx-auto py-8 px-4 sm:px-6 lg:px-8">
            <div class="bg-white shadow-md rounded-lg p-6">
                ...
                <!-- Основной контейнер -->
                <div class="bg-white shadow-md rounded-lg p-0 h-screen flex flex-col max-h-[calc(100vh-4rem)]"> 
                    <!-- h-screen и flex-col для общей структуры, max-h для ограничения высоты -->
                    ...
                    <div class="overflow-y-auto flex-grow border border-gray-200 rounded-lg p-2"> 
                        <!-- flex-grow для растяжения, overflow-y-auto для прокрутки -->
