...
<!--                            @if($key !== 'page')  Исключаем page, если не нужно -->
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                        <div class="mb-2 md:col-span-2"> <!-- md:col-span-2 означает, что первое поле займёт 2/3 ширины -->
                        ...
                        <div class="mb-2 md:col-span-1"> <!-- Второе поле займёт 1/3 ширины -->
